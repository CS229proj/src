...
def save_cm(cm, filename, target_names):
    ...
    plt.title("Confusion Matrix - Yandex Translator API")
    plt.colorbar()
...
def main():
    ...
    [Xgold, ygold, pred] = load_results('output/benchmarks/yandex.dat', labels)
    pred.insert(5489, 'id')
    print ('test', set(pred))
    ...
    save_cm(cm, 'output/benchmarks/yandex_cm.png', labels)
